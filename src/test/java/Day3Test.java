...
public class Day3Test {
    ...
    @Test
    public void should_return_number_of_inches_overlaps_in_the_problem() {
        Day3 day3 = new Day3();
        List<String> claims = Arrays.asList("#1 @ 167,777: 23x12",
            "#2 @ 253,106: 10x25",
            "#3 @ 104,622: 11x25",
            "#4 @ 267,61: 14x16",
            "#5 @ 829,831: 19x10",
        ...
        String[][] piece = day3.drawClaim(claims);
        List<String[]> collect = Arrays.stream(piece).collect(Collectors.toList());
        int overlaps = 0;
